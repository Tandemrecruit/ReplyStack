    ...
    <div className="space-y-8">
      ...
      <section className="p-6 bg-surface rounded-lg border border-border">
        ...
        <div className="mt-4 p-4 bg-background-secondary rounded-md">
          <p className="text-sm text-foreground-secondary">
            Your free trial ends in <span className="font-medium text-foreground">14 days</span>
          </p>
        </div>
      </section>
      ...
      <section className="p-6 bg-surface rounded-lg border border-border">
        ...
        <div className="mt-6 p-6 border border-primary-200 rounded-lg bg-primary-50">
          ...
          <button className="mt-6 w-full px-4 py-2 bg-primary-600 text-white rounded-md font-medium hover:bg-primary-700 transition-colors">
            Upgrade Now
          </button>
        </div>
      </section>
