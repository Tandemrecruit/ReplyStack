    ...
    <div className="min-h-screen bg-background text-foreground">
      <header className="border-b border-border bg-surface/80 backdrop-blur">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 text-sm">
            <Link className="text-foreground-secondary hover:text-foreground" href="/login">
              Sign in
            </Link>
            <Link
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <p className="mt-3 text-foreground-secondary">
          This is a plain-language summary of how ReplyStack handles data. If you have questions,
          email{" "}
          <a className="text-primary-700 hover:underline" href="mailto:support@replystack.com">
        ...
        <div className="mt-10 space-y-8">
          <section className="space-y-2">
            ...
            <ul className="list-disc pl-5 text-foreground-secondary space-y-1">
              ...
              <li>Google Business Profile data you connect (reviews, locations).</li>
          ...
          <section className="space-y-2">
            ...
            <p className="text-foreground-secondary">
              We use trusted service providers (for hosting, payments, email, and AI generation)
              only as needed to deliver the service. We don’t sell your data.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-foreground-secondary">
              We take reasonable steps to protect your information. Sensitive tokens should be
              stored encrypted at rest and never exposed client-side.
            </p>
          </section>
